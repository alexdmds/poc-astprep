...
-- Réinsérer le produit de base (requis comme FK par sections, questions, mock_tests…)
INSERT INTO products (id, name, accent_color) VALUES ('tage_mage', 'TAGE MAGE', 'primary');
